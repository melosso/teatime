...
/// <summary>
/// Renders a newsletter fenced block into a static sign-up form at parse time; every text field takes a plain string or a locale map.
/// </summary>
public static class NewsletterBlock
{
    ...
    /// <summary>
    /// Resolves one field for the active locale: exact code, then base language, then English, then the built-in string.
    /// </summary>

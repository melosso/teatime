...
public static partial class PostListRenderer
{
    ...
    public static string BuildPostHeader(Post post, string basePath, string? author, string? authorImage, string? authorUrl)
    {
        ...
        if (post.Tags.Count > 0)
        {
            ...
            if (slug.Length > 0)
                sb.Append("<a class=\"post-kicker\" href=\"").Append(UrlPaths.Href(basePath, $"tags/{slug}"))
    ...
    internal static string Avatar(string author, string? authorImage, string basePath)
    {

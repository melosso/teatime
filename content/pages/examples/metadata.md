...
Every page adapts an Open Graph set (`og:type`, `og:title`, `og:url`, `og:description`, plus `og:image` when there is one) and the matching Twitter fields (`twitter:title`, `twitter:description`, `twitter:card`, `twitter:image`).

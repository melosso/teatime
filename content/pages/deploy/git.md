...
If `content/` is a subdirectory of the repo rather than the repo root, set `GIT_ROOT` to where the repo itself should be cloned and point `Docs__RootPath` at the subdirectory within it:
